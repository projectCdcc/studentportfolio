        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            ...
                                            <div id="jobShow" class="flex items-center">
                                                ...
                                                <button type="button"
                                                    data-modal-target="readJobModal"
                                                ...
                                                <button type="button" data-modal-target="deleteModal"
                                                    ...
                                                    data-job-id="{{ $job->id }}"
                                                    class="flex w-full items-center py-2 px-4 hover:bg-gray-200 dark:hover:bg-gray-600 text-red-500 dark:hover:text-red-700">
                        ...
                        <form action="{{ route('empJob.store', [$id=Auth::user()->id]) }}" method="POST">
                            ...
                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea id="description" name="requirement" rows="4"
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                ...
                                <div class="sm:col-span-2">
                                    <label for="description"
                                        ...
                                        Apply</label>
                                    <textarea id="description" name="apply" rows="4"
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
            ...
            <div id="deleteModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <!-- Modal content -->
                    <div class="relative p-4 text-center bg-blue-200 rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        <button type="button"
                                        ...
                                        $(document).ready(function () {
                                            ...
                                            deleteButtons.forEach(function (button) {
                                                button.addEventListener('click', function () {
                                                    ...
                                                    var formAction = "{{ route('employer.job.destroy', ['userId' => Auth::user()->id, 'jobId' => ':jobId']) }}";
